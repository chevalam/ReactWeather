...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
	  ...
	  onHandleFormClick: function onHandleFormClick(updates) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(GreeterForm, { onNewClickFunction: this.onHandleFormClick })
	    );
	  }
	});
	...
	var GreeterForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', ref: 'name', placeholder: 'Enter Heading' }),
